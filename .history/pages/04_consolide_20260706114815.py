...
with st.sidebar:
    ...
    st.info(
        ...
        "(tous clients et toutes origines confondus, y compris les "
        "**Nouveaux Projets** sélectionnés en page 05).\n\n"
...
# ── AJOUT : fusionner les projets (nouveaux + doublons) AVEC la source AVANT
# consolidation -- au lieu d'apres, comme avant. C'est ca qui corrige le bug :
# une ref en commun entre programme/carnet ET projet doit ressortir comme UNE
# SEULE ligne consolidee, avec ORIGINE = "LPC/PROJET" (ou "CARNET/PROJET") et
# les quantites REELLEMENT SOMMEES -- pas deux lignes separees comme avant.
