...
if st.button("✅ Intégrer dans la consolidée (page 04)", type="primary",
    ...
    # Mapper NUM_PROJET → PROGRAMME pour cohérence avec les autres pages
    if 'NUM_PROJET' in df_a_integrer.columns and 'PROGRAMME' not in df_a_integrer.columns:
        df_a_integrer['PROGRAMME'] = df_a_integrer['NUM_PROJET'].astype(str)
